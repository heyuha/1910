...
<meta name="csrf-token" content="{{ csrf_token() }}">
     ...
     <form  method="post" action="{{url('/login/regstore')}}" class="reg-login">
    ...
    <script>
      $("button").click(function(){
          ...
          if(reg.test(name)){
            ...
            $.post('/login/sendSms',{mobile:name},function(result){
                alert(result.msg);
            },'json');
            return;
          }
          ...
          if(emailreg.test(name)){
            $.get('/login/sendEmail',{email:name},function(result){
                alert(result.msg);
            },'json');
            return;
          }
